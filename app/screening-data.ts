...
const aaoifiDatasetRows: AaoifiDatasetRow[] = [
  ...
  { ticker: "MSA", shariaStatus: "Sharia-compliant", activityClassification: "Compliant", debtRatio: 0.023, debtStatus: "PASS", depositsRatio: 0.035, depositsStatus: "PASS", nonCompliantRevenueRatio: 0.003, revenueStatus: "PASS", screeningComment: "AAOIFI status: Sharia-compliant. Acceptable activity — Permitted service activity. Debt / Market Cap: 2.3% (threshold 30.0%) → ✓ OK. Interest-bearing Cash / Market Cap: 3.5% (threshold 30.0%) → ✓ OK. Non-compliant Revenue / Total Revenue: 0.3% (threshold 5.0%) → ✓ OK." },
  ...
  { ticker: "RIS", shariaStatus: "Not Sharia-compliant", activityClassification: "Not compliant", debtRatio: 0, debtStatus: "N/A", depositsRatio: 0, depositsStatus: "N/A", nonCompliantRevenueRatio: 0, revenueStatus: "N/A", screeningComment: "AAOIFI status: Not Sharia-compliant. The company fails the activity screen because its hospitality activity is not Sharia-compliant under AAOIFI. Financial ratio tests are not applicable once the activity screen fails." },
